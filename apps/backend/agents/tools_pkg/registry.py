...
Central registry for creating and managing turret MCP tools.
"""
...
def create_turret_mcp_server(spec_dir: Path, project_dir: Path):
    """
    Create an MCP server with turret custom tools.
    ...
    return create_sdk_mcp_server(name="turret", version="1.0.0", tools=tools)
