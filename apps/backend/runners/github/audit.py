...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".turret/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .turret/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".turret/github/audit")
