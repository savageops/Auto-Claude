...
# Create validator
spec_dir = Path("turret/specs/001-feature")
...
python turret/validate_spec.py --spec-dir turret/specs/001-feature/ --auto-fix --checkpoint plan

# JSON output
python turret/validate_spec.py --spec-dir turret/specs/001-feature/ --checkpoint all --json
```
